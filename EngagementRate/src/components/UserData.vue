...
let _user_posts = [];
//let _usernametest = 'bugfathercom.jpg';
//import variables from '../variables'
let _PHOTO_URL= '../../public/src/assets/bugfathercom.jpg';
...
export default defineComponent({
    data() {
        return {
            ...
            notFound: false,
            avg_likes: 0,
            usernametestt: 'bugfathercom.jpg',
    ...
    methods: {
        Init() {
            ...
            this.GetUserByUserName(this.userName).then(function (result) {
                ...
                _this.user.profileImage = instagramUserData.profile_pic_url;
